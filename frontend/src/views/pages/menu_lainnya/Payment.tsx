...
import ListPatientPaymentTable from "../../../components/ListPatientPayment/ListPatientPaymentTable";
...
export default function ListPasien() {
  ...
  useEffect(() => {
    document.title = "Pembayaran Pasien";
  }, [data]);
    ...
    <section>
      ...
      <div className="flex flex-col">
        {isLoading ? (
          ...
          <ListPatientPaymentTable patients={patients} />
        )}
      </div>
    </section>
  );
